...
int ConnectToCtim(unsigned int  ctim) {
...
int ConnectToPtim(unsigned int  ptim) {
...
char      *cp,
   ...
   events=0;
   bzero((void *) event,  MAX_EVENTS * sizeof(unsigned int ));
   bzero((void *) tclass, MAX_EVENTS * sizeof(unsigned int ));
