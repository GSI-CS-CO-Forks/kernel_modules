...
{ 0, CtrDrvrSET_MODULE_BY_SLOT,     "SET_MODULE_BY_SLOT" },     /* Select the module to work with by slot ID */
{ 0, CtrDrvrGET_MODULE_SLOT,        "GET_MODULE_SLOT" },        /* Get the slot ID of the selected module */
};
